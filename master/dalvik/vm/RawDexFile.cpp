...
//    //salma // not captured
//    int configFd = -1;
//    __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "RawDexFile.cpp: Try to open config.xml");
//    configFd = open("/sdcard/config.xml", O_RDONLY);
//    if(configFd < 0)
//    	__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "RawDexFile.cpp: FAIL Try to open config.xml");
//    else
//    	__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "RawDexFile.cpp: SUCCESS Try to open config.xml");
////endsalma
    ...
    //just debug
    //Not captured
    //Note: dvmDexFileOpenFromFd is called from JarFile.cpp instead
    //__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "RawDexFile.cpp: just before calling dvmDexFileOpenFromFd");
    //endsalma
...
//salma
    //just debug
    __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "RawDexFile.cpp: Successfully opened '%s'", fileName);
    //endsalma
