...
{
	//salma
	//ALOGD("salma: Continuing optimization (%s, isb=%d)", fileName, isBootstrap);
	//endsalma
...
bool dvmPrepareDexInMemory(u1* addr, size_t len, DvmDex** ppDvmDex)
{
    DexClassLookup* pClassLookup = NULL;
//salma // not captured
 //   ALOGD("salma: DexPrepare: dvmPrepareDexInMemory");
    //salma
    /*
...
{
	//salma
	//ALOGD("Salma: DexPrepare.cpp: rewriteDex");
	//endsalma
    DexClassLookup* pClassLookup = NULL;
    ...
    //salma
   //	ALOGD("DexPrepare.cpp: rewriteDex before first bail");
    //endsalma
     ...
     */
    //salma
   	//ALOGD("DexPrepare.cpp: rewriteDex before second bail");
    //endsalma
     ...
     */
    //salma
   	//ALOGD("DexPrepare.cpp: rewriteDex before third bail");
    //endsalma
     ...
     */
    //salma
   //	ALOGD("DexPrepare.cpp: rewriteDex before fourth bail");
    //endsalma
    if (!doVerify && !doOpt) {
        result = true;
        goto bail;
     ...
     */
    //salma
   	//ALOGD("DexPrepare.cpp: rewriteDex before fifth bail");
    //endsalma
     ...
     */
    //salma
   	//ALOGD("DexPrepare.cpp: rewriteDex before sixth bail");
    //endsalma
    ...
    //salma
	//ALOGD("Salma: DexPrepare.cpp: rewriteDex before calling my function");
    //endsalma
