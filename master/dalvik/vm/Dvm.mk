...
#salma: Commented out the next line and change the value to true in the after next following line
...
## Salma: added new source files. DvmConfig.cpp and DvmSystemCoreValues.cpp DvmSystemSwitchDecisionTree.cpp
LOCAL_SRC_FILES := \
	AllocTracker.cpp \
	Atomic.cpp.arm \
	AtomicCache.cpp \
...
ifeq ($(dvm_arch),arm)
  ...
  #salma: switch between .S to C-allstubs to allow easier learning and debugging (this is slower )
  LOCAL_SRC_FILES += \
