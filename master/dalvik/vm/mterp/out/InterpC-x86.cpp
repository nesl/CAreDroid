...
#define GOTO_invoke(_target, _methodCallRange)                              \
    do {                                                                    \
    	__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "gotoinvoke");\
...
#define GOTO_invokeMethod(_methodCallRange, _methodToCall, _vsrc1, _vdst)   \
    do {                                                                    \
    	__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "gotoinvokemethod");\
