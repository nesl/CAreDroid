...
static jobject NewObject(JNIEnv* env, jclass jclazz, jmethodID methodID, ...) {
    ...
    //salma
   // ALOGD("Jni newObjClass=%s", newObj->clazz->descriptor);
   // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","jni new object");
     //endsalma
...
static jobject NewObjectV(JNIEnv* env, jclass jclazz, jmethodID methodID, va_list args) {
    ...
    //salma
   // ALOGD("Jni newObjClass=%s", newObj->clazz->descriptor);
   // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","jni new objectV");
     //endsalma
    return result;
}
...
static jobject NewObjectA(JNIEnv* env, jclass jclazz, jmethodID methodID, jvalue* args) {
    ...
    //salma
  //  ALOGD("Jni newObjClass=%s", newObj->clazz->descriptor);
   // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","jni new objectA");
     //endsalma
    return result;
}
...
static jmethodID GetMethodID(JNIEnv* env, jclass jclazz, const char* name, const char* sig) {
    ...
    //salma
   // ALOGD("Jni newObjClass=%s", newObj->clazz->descriptor);
   // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","jni get method id");
     //endsalma
    return (jmethodID) meth;
}
