...
struct ClassObject : Object {
    ...
    //salma
    /*Replaceable table
     * For each sensitive class their exists a replaceable table that points
     * to sensitive methods in increasing order according to their priority
     */
    bool			isSensitiveClass; //set while creating Vtable
   // u4 			    repMethodCount; //not used
   // Method**      	reptable; //not used
    u4 				classID; //Set in the class initialization
    //endsalma
...
struct Method {
    ...
    //salma
    /* check if this method is replaceable
     * It is set during initialization of its class
     * */
    bool isReblaceable;
    /* Pointer to the replaceable method table table ... It is arranged in order with higher priority */
   // Method** replaceTable;
    /* Priority
     *  It is set during initialization of its class
     * */
    u4 priority; //for now least priority = repMethodCount in its class
 ...
 */
////salma
//INLINE bool dvmIsReplaceableMethod(const Method* method) {
//	return (method->isReblaceable);
//}
////ensalma
...
//salma
bool dvmIsClassSensitive(ClassObject* clazz);
//endsalma
