    ...
    MethodType methodType)
{
    ...
    //salma
     //   __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "dvmResolveMethod --- found method %d (%s.%s)", methodIdx, resClass->descriptor, resMethod->name);
        //salma
 ...
 //salma
     //   __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "dvmResolveMethod not caching resolved method %s.%s (class init=%d/%d)",resMethod->clazz->descriptor, resMethod->name,
      //      dvmIsClassInitializing(resMethod->clazz),
       //     dvmIsClassInitialized(resMethod->clazz));
        //salma
    } else {
...
//salma
 //       __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG", "dvmResolveMethodInterface-found method %d (%s.%s)", methodIdx, resClass->descriptor, resMethod->name);
        //salma
