                         ...
                         bool isRange)
{
    ...
    //salma
   // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","inlineGetter: methodclazz=%s, methodname=%s", calleeMethod->clazz->descriptor, calleeMethod->name);
    //endsalma
    /*
                         ...
                         bool isRange)
{
    ...
    //salma
   //__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","inlineSetter: methodclazz=%s, methodname=%s", calleeMethod->clazz->descriptor, calleeMethod->name);
    //endsalma
    /*
...
{
    //salma
    //__android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","inlineemptyvirtual: methodclazz=%s, methodname=%s", calleeMethod->clazz->descriptor, calleeMethod->name);
    //endsalma
	MIR *invokeMIRSlow = (MIR *)dvmCompilerNew(sizeof(MIR), true);
    *invokeMIRSlow = *invokeMIR;
    invokeMIR->dalvikInsn.opcode = (Opcode)kMirOpCheckInlinePrediction;
                                     ...
                                     bool isRange)
{
    ...
    //salma
    //    __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","tryInlineVirtualCallsite: methodclazz=%s, methodname=%s", calleeMethod->clazz->descriptor, calleeMethod->name);
    //endsalma
    return false;
}
    ...
    while (true) {
        ...
        switch (opcode) {
            ...
            case OP_INVOKE_INTERFACE:
                ...
                calleeMethod = lastMIRInsn->meta.callsiteInfo->method;
                //salma
               // __android_log_print(ANDROID_LOG_DEBUG, "DVM DEBUG","dvmCompilerInlineMIR: methodclazz=%s, methodname=%s", calleeMethod->clazz->descriptor, calleeMethod->name);
                //endsalma
                break;
