    ...
    for (i = 0; i < argc; i++) {
            ...
            strncmp(argv[i], "-agentlib:jdwp=", 15) == 0)
        {
            ...
            if (argv[i][5] == ':') {
                ...
                {//salma
                	ALOGD("vm/init.cpp: stncmp = portable"); //endsalma
                ...
                { //salma
                	ALOGD("vm/init.cpp: stncmp = jit"); //endsalma
            	...
            	//salma
            	ALOGD("vm/init.cpp: default = fast"); //endsalma
                gDvm.executionMode = kExecutionModeInterpFast;
            }
...
#if defined(WITH_JIT)
    //salma
   // ALOGD("vm/init.cpp: default execution mode with JIT");
    //endsalma
    gDvm.executionMode = kExecutionModeJit;
    gDvmJit.num_entries_pcTable = 0;
    gDvmJit.includeSelectedMethod = false;
