...
struct DexMethodId {
    ...
    //salma
    //u1 isReplaceable;      							 /* whether this method is replaceable of not */
    //std::vector<u4> methodCandidates; 					/* vector with the candidate methods Ids to be replaced with*/
    //endsalma
};
...
struct DexClassDef {
    ...
    //salma
    //u1 isSensitiveClass;	/* Whether this class will have replaceable methods or not*/
    //endsalma
};
...
//salma //wrapper for the dexFindClass
//DexClassDef* dexFindClassWrapper(DexFile* pFile, const char* descriptor);
